...
class Insight(models.Model):
    end_year = models.CharField(max_length=512, blank=True, null=True)
    intensity = models.IntegerField(blank=True, null=True)
    sector = models.CharField(max_length=512, blank=True, null=True)
    topic = models.CharField(max_length=512, blank=True, null=True)
    ...
    start_year = models.CharField(max_length=512, blank=True, null=True)
    impact = models.CharField(max_length=512, blank=True, null=True)
    ...
    pestle = models.CharField(max_length=512, blank=True, null=True)
